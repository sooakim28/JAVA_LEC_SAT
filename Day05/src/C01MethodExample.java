 ...
 *      
 * 2) 형태: 매소드명(); 메소드와 변수를 구분하는 방법 (실행할때)
 *         ex. System.out.println(); 에서 System은 클래스, out은 변수, println("안녕하세요");은 매소드
 *      
 *      
 *    // 담배사와(); <-- 투입값이 없어요 (무인자 메소드) 
 *    // 담배사와( int money ) <-- 담배심부름을 시키는데, 내 돈을 주고  시켰다
 *      
 *      
 * 3) 사용하는 이유: 매소드 = 행위(행동)*
 *         (1) 반복업무 줄이기*
